...
## Read Data for stock, year=yr, catch=ct, and resilience=res. 
# Expects space delimited file with header yr  ct and years in
# integer and catch in real with decimal point
## For example
## stock	res	 yr     ct       
## cap-icel	Medium 1984  1234.32 

setwd('~/OSS2014/Regional_Collapse/CatchMSY/Output')
filename <- "../Input/RC_CMSY_data_one_off.csv"
outfile  <- "RC_CMSY_data_one_off_Output.csv"
logfile  <- file("RC_CMSY_data_one_off.txt")
